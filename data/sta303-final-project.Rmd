...
## Research Question 1:
key findings + graph + table + conclusion
...
customer <- readRDS("~/Desktop/STA303/final project/rstudio-export (2)/data/customer.Rds")

# identify the new customers
customer <- customer %>% mutate(new_customer = as.factor(ifelse(line %in% c("Advance", "Active"), 1, 0)))
